    ...
    <div class="row">
        <div class="col-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="../controllers/c_foto.php?aksi=update" class="p-2" method="post">
                          <?php 
                         foreach ($tampil->select($_SESSION['foto']['FotoId']) as $edit) :  ?>
                    
                    <input type="text" name="FotoId" value="<?= $edit->FotoId?>" hidden>
                    <input type="text" name="AlbumId" value="<?= $edit->AlbumId?>" hidden>
                    <input type="text" name="UserId" value="<?= $edit->UserId?>" hidden>
